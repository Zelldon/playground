...
EZE 0.7.0 - 1.3.0 Zeebe

```
Result "io.zell.MyBenchmark.testEngineThroughput":
  1034.774 ±(99.9%) 42.824 ops/s [Average]
  (min, avg, max) = (948.871, 1034.774, 1122.019), stdev = 57.169
  CI (99.9%): [991.950, 1077.599] (assumes normal distribution)
...
Benchmark                          Mode  Cnt     Score    Error  Units
MyBenchmark.testEngineThroughput  thrpt   25  1034.774 ± 42.824  ops/s
